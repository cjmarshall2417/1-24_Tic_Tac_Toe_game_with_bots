...
namespace TicTacToe_Application
{
    class Program
    {
                ...
                while (true)
                {
                    ...
                    if (player1Turn)
                    {
                        ...
                        while (true)
                        {
                            ...
                            {
                                player1Selections.Add(MakeSelection(player1Selections, player2Selections, validWins));
                                break;
                            }
                    ...
                    else
                    {
                        ...
                        while (true)
                        {
                            ...
                            {
                                player2Selections.Add(MakeSelection(player2Selections, player1Selections, validWins));
                                break;
                            }
                            selection = Console.ReadLine();
        ...
        public static int MakeSelection(List<int> playerSelections, List<int> opponentSelections, int[][] validWins)
        {
            ...
            //now test if its possible for player to win
